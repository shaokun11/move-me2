...
export async function getMoveHA(method: string, param: string): Promise<any> {
  const url = process.env.REACT_APP_MOVE_EVMCHECK||'https://mevm.devnet.m1.movementlabs.xyz/';
...
// sendApiRequest("debug_getMoveHash", ["0xef70320e15721d544f79d84f8437d490da8119dd4e8635a0040853bb61bcc8c8"]);
