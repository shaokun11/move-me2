<!-- The singleton common components need in @ / components/ComponentExamples write sample directory -->

<script>
import _ from 'lodash'
import Vue from 'vue'

// Globally register the v-highlight directive for all example components
...
// Full import component library for all example components (use CommonJS to bypass babel's import on demand plug-in)
require('element-ui/lib/theme-chalk/index.css')
Vue.use(require('element-ui'))

const requireCtx = require.context(
  '../ComponentExamples',
  false, // Subfolders are not resolved
  /[/\\][A-Z][a-zA-Z0-9]+\.vue$/, // File names use the PascalCase naming method
)
const requireCtxRaw = require.context(
  '!raw-loader!../ComponentExamples',
  false, // Ditto
  /[/\\][A-Z][a-zA-Z0-9]+\.vue$/, // Ditto
)
