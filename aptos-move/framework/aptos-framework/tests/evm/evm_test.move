...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let addresses = vector[x"095e7baea6a6c7c4c2dfeb977efac326af552d87", x"2adc25665018aa1fe0e6bc666dac8fc2697ff9ba", x"a94f5374fce5edbc8e2a8697c15331677e6ebf0b"];
        let balance_table = vector[0x00, 0x00, 0x0de0b6b3a7640000];
        let codes = vector[x"6000600155", x"", x"6000600155"];
        let nonce_table = vector[0x00, 0x01, 0x00];
        let i = 0;
