...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let data = x"0000000000000000000000001000000000000000000000000000000000000003";
        ...
        simple_map::add(&mut storage_maps, x"1000000000000000000000000000000000000001", init_storage(vector[0x01], vector[0x01]
));
        ...
        let addresses = vector[x"1000000000000000000000000000000000000000", x"1000000000000000000000000000000000000001", x"1000000000000000000000000000000000000002", x"1000000000000000000000000000000000000003", x"1000000000000000000000000000000000000004", x"2000000000000000000000000000000000000003", x"3000000000000000000000000000000000000003", x"a94f5374fce5edbc8e2a8697c15331677e6ebf0b"];
        let balance_table = vector[0x0de0b6b3a7640000, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x0de0b6b3a7640000];
        let codes = vector[x"6000600060006000600035620186a0fa600055600160015500", x"600160015500", x"600060015500", x"60006000600060006000732000000000000000000000000000000000000003619c40f150600160015200", x"60006000600060006001733000000000000000000000000000000000000003619c40f250600160015200", x"600a6001a0600160015200", x"600160015200", x""];
