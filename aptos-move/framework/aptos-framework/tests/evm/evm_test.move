...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let gas_limit = u256_to_data(0x100748);
        ...
        let balance_table = vector[0x03e8, 0x05f5e100];
        let codes = vector[x"60406000604060006103e873945304eb96065b2a98b57a48a06ae28d285a71b561c350f260005500", x""];
