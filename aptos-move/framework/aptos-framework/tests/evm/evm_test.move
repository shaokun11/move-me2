...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let addresses = vector[x"0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6", x"a94f5374fce5edbc8e2a8697c15331677e6ebf0b"];
        let balance_table = vector[0x00, 0x6400000000];
        let codes = vector[x"6000600e80601760003960006000f5503d6000550000fe6211223360005260206000fd0000", x""];
