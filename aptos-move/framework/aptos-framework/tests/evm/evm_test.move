...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let data = x"";
        ...
        let gas_limit = u256_to_data(0x3291d5d5);
        let gas_price = vector[u256_to_data(0x0a)];
        let value = u256_to_data(0x73d5af9c);
        let tx_type = 0;
        ...
        let codes = vector[x"", x"6000355415600957005b60203560003555", x""];
