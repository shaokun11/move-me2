...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let balance_table = vector[0x0ba1a9ce0ba1a9ce, 0x0ba1a9ce0ba1a9ce];
        let codes = vector[x"", x""];
