...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let addresses = vector[x"1000000000000000000000000000000000000000", x"1100000000000000000000000000000000000000", x"2000000000000000000000000000000000000000", x"a94f5374fce5edbc8e2a8697c15331677e6ebf0b"];
        let balance_table = vector[0x2710, 0x00, 0x2710, 0x2386f26fc10000];
        let codes = vector[x"602d80600f60003960006000f000fe600060006000600060017310000000000000000000000000000000000000016207a120f2600155600160025500", x"60006000600060006000600035620493e0f100", x"6000602d80601160003960006000f500fe600060006000600060017310000000000000000000000000000000000000016207a120f2600155600160025500", x""];
