...
module aptos_framework::evm_test {
    ...
    public fun test_run() {
        ...
        let gas_limit = u256_to_data(0x035b60);
        ...
        let addresses = vector[x"1000000000000000000000000000000000000110", x"1000000000000000000000000000000000000111", x"a94f5374fce5edbc8e2a8697c15331677e6ebf0b", x"b94f5374fce5edbc8e2a8697c15331677e6ebf0b"];
        let balance_table = vector[0x00, 0x00, 0xe8d4a51000, 0x00];
        let codes = vector[x"5a60085560ff60ff60ff60ff6000731000000000000000000000000000000000000111620927c0f1600955", x"5a600855600060006000f050600060006000f0505a6009555a600a55", x"", x"5a60085560ff60ff60ff60ff6000731000000000000000000000000000000000000110620927c0f1600955"];
