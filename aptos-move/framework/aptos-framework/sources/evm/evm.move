module aptos_framework::evm {
    ...
    struct CallsEvent has drop, store {
    ...
    fun test_pancake_v3(aptos_framework: signer) acquires Account, ContractEvent {
        ...
        let deployer = execute(sender, ZERO_ADDR, 0, deployer_bytecode, 0);
        ...
        vector::append(manager_bytecode, weth9);
        let manager = execute(sender, ZERO_ADDR, 3, *manager_bytecode, 0);
        ...
        let tokenA = execute(sender, ZERO_ADDR, 4, erc20, 0);
        let tokenB = execute(sender, ZERO_ADDR, 5, erc20, 0);
        ...
        execute(sender, tokenA, 6, *mint_token_data, 0);
        execute(sender, tokenB, 7, *mint_token_data, 0);
        ...
        execute(sender, tokenA, 8, *approve_data, 0);
        execute(sender, tokenB, 9, *approve_data, 0);
        ...
        vector::append(add_liquidity_data, u256_to_data(0));
        execute(sender, manager, 11, *add_liquidity_data, 0);
    }
