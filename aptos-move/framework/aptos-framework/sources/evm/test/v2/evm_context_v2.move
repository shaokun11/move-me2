module aptos_framework::evm_context_v2 {
    ...
    public(friend) native fun get_balance_storage_for_test<Storage>(address: vector<u8>): u256;
    public(friend) native fun get_state_storage_for_test<Storage>(address: vector<u8>, index: u256): u256;
    ...
    public(friend) native fun execute_tx<Storage>(env: Env, from: vector<u8>, to: vector<u8>, value: u256, data: vector<u8>, gas_limit: u256,
                                         gas_price: u256, max_fee_per_gas: u256, max_priority_fee_per_gas: u256, access_list_address_len: u64,
                                         access_list_slot_len: u64, tx_type: u8): (u64, u256);
}