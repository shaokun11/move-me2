module aptos_framework::evm_for_test {
    ...
    public fun test_run() acquires ExecResource {
        ...
        let balance_table = vector[
            ...
            0x0ba1a9ce0ba1a9ce, 0x0ba1a9ce0ba1a9ce,
            0x0ba1a9ce0ba1a9ce, 0x0ba1a9ce0ba1a9ce,
            0x0ba1a9ce0ba1a9ce, 0x100000000000,
            0x0ba1a9ce0ba1a9ce
        ];
        ...
        run_test(
            addresses,
            vector[
                x"61600d6000556010602002565b00",
                x"61600d60005560016010602002575b00",
                x"600456005b61600d60005500",
                x"61600d600055630fffffff5600",
                x"602360085660015b600255",
                x"61600d6000555b600656",
                x"61600d60085660ff5b600055",
                x"600b565b61600d600055005b600356",
                x"600260050156005b61600d600055",
                x"60055600605b61600d600055",
                x"60055600600161600d600055",
                x"61600d600055600b565a5b5a600155",
                x"61600d6000556009565a5b5a600155",
                x"6801000000000000000b565b5b6001600155",
                x"640100000007565b5b6001600155",
                x"600051506001600003506000515661600d60005500",
                x"600e565b5b5b5b5b5b5b5b5b5b5b5b5b5b5b5b61600d600055",
                x"",
                x"60006000600060006004356110000162010000f400"
            ],
            *nonces,
            balances,
            storage_keys,
