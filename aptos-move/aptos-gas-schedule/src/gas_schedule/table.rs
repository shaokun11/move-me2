...
crate::gas_schedule::macros::define_gas_parameters!(
    ...
    [
        ...
        [borrow_box_base: InternalGas, "borrow_box.base", 0],
        [borrow_box_per_byte_serialized: InternalGasPerByte, "borrow_box.per_byte_serialized", 0],

        [contains_box_base: InternalGas, "contains_box.base", 0],
        [contains_box_per_byte_serialized: InternalGasPerByte, "contains_box.per_byte_serialized", 0],

        [remove_box_base: InternalGas, "remove_box.base", 0],
        [remove_box_per_byte_serialized: InternalGasPerByte, "remove_box.per_byte_serialized", 0],
